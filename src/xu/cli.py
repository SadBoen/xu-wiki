...
def build_parser() -> argparse.ArgumentParser:
    ...
    sp = sub.add_parser("ingest-commit", help="Assign node_path to an existing node (ingest-file created)")
    sp.add_argument("--wiki", required=True)
    sp.add_argument("--uid", default="", help="UID of existing node (created by ingest-file)")
    sp.add_argument("--pending", default="", help="(legacy) path to old pending file")
    ...
    sp.add_argument("--native", default="", help="raw markdown string (bypass parse, deprecated)")
    sp.add_argument("--source", default="", help="abs path to source file (required when --native is used)")
